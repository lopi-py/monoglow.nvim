...
local function generate_style(colors)
  return {
    ...
    -- Search
    ["search.match_background"] = hex8a(colors.visual, "99"),
    ...
    ["editor.document_highlight.bracket_background"] = hex8a(colors.visual, "66"),
